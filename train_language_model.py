...
def generate_captions_csv(folder_captions):
    ...
    read_captions_and_save(training_files, folder_captions, config.TRAINING_CAPTIONS_FILE)
    read_captions_and_save(test_files, folder_captions, config.TEST_CAPTIONS_FILE)
